...
namespace LabTestVerThree.NavbaR
{
    public class NavbarLaborant
    {
        public IEnumerable<NavbarItem> NavbarTop()
        {
            ...
            topNav.Add(new NavbarItem() { Id = 2, action = "Index", nameOption = "Заполнение результатов", controller = "JorAddResult", isParent = false, parentId = 1 });
