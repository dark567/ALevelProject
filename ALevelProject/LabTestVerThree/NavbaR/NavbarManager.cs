...
namespace LabTestVerThree.NavbaR
{
    public class NavbarManager
    {
        public IEnumerable<NavbarItem> NavbarTop()
        {
            ...
            // End drop down Menu
            topNav.Add(new NavbarItem() { Id = 8, action = "OtherAction", nameOption = "Данные пользователя", controller = "Admin", isParent = false, parentId = -1 });

            topNav.Add(new NavbarItem() { Id = 9, action = "Logout", nameOption = "Выйти", controller = "Account", isParent = false, parentId = -1 });
